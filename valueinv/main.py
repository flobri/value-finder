    ...
    with tab0:
        ...
        with mid_col:
            with st.container():
                ...
                price = go.Scatter(x=data_an['Date'], y=data_an['Adj Close'], mode='lines', name='Price', yaxis='y2')
                cashflow_bar = go.Bar(x=plot_data.index, y=plot_data['pershareFreeCashflow'],
                                      name='FreeCashflow je Share', yaxis='y1')
                netIncome_bar = go.Bar(x=plot_data.index, y=plot_data['reportedEPS'], name='NetIncome je Share',
                                       yaxis='y1')
                revenue_bar = go.Bar(x=plot_data.index, y=plot_data['pershareRevenue'], name='Revenue je Share',
                                     yaxis='y1')
            ...
            with st.container():
                ...
                if kpi == 'KGV':
                    ...
                    pe_line = go.Scatter(x=jahre_str, y=kgv, mode='lines', name='P/E-Ratio',line=dict(width=3))
                ...
                if kpi == 'KBV':
                    ...
                    pe_line = go.Scatter(x=jahre_str, y=kbv, mode='lines', name='P/B-Ratio',line=dict(width=3))
                ...
                if kpi == 'KUV':
                    ...
                    pe_line = go.Scatter(x=jahre_str, y=kuv, mode='lines', name='P/R-Ratio',line=dict(width=3))
